...
// APIClient manages communication with the FReD API v0.0.3
...
type APIClient struct {
	...
	KeygroupApi *KeygroupApiService

	ReplicationApi *ReplicationApiService

	SeedApi *SeedApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.KeygroupApi = (*KeygroupApiService)(&c.common)
	c.ReplicationApi = (*ReplicationApiService)(&c.common)
	c.SeedApi = (*SeedApiService)(&c.common)
